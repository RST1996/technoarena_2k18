...
<?php
	...
	$query = "SELECT `registration`.`id`,`registration`.`ta_id`,`registration`.`name`,`events`.`name` AS `e_name`, `registration`.`fees_paid` FROM `registration`,`events` WHERE `registration`.`event_id` = `events`.`id`";
